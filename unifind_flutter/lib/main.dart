                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 24),
                              _LoadingButton(loading: _loading, onTap: _submit),
                            ],
                          ),
                        ),
...
class _LoadingButtonState extends State<_LoadingButton> with SingleTickerProviderStateMixin {
  late AnimationController _c;
  late Animation<double> _scale;
        ...
        child: Container(
          ...
          child: Center(
            child: widget.loading
                ...
                : const Text('Sign In', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w800, letterSpacing: 0.3)),
          ),
        ),
      ),
    );
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              _LoadingButton(loading: false, onTap: _submit),
              const SizedBox(height: 20),
            ],
          ),
        ),
