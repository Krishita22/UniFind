...
class _FaqSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const List<_FaqData> faqs = [
      ...
      _FaqData('What categories are available?', 'Marketplace includes Beauty & Personal Care, Clothing, Dorm Essentials, Electronics, Instruments, Kitchen & Appliances, Lab Equipment, Other, School Supplies, Sports & Fitness, Textbooks, and Tickets.\n\nLost & Found includes Electronics, Bags, Keys, ID/Cards, Wallets, Water Bottles, Clothing, Accessories, and Other.'),      _FaqData('How does Lost & Found work?', 'Students can post items they\'ve lost or found on campus. Browse the feed, filter by category, and reach out to reunite items with their owners.'),
...
class _ContactSectionState extends State<_ContactSection> {
  ...
  try {
    final response = await http.post(
      Uri.parse('https://cyan.csam.montclair.edu/~ivanovs1/UniFind_API/contact/contact.php'),
