          ...
          children: [
            ...
            Container(
              ...
              child: const Row(children: [
                ...
                Expanded(
                  child: Text(
                    'Payment will be processed once the meeting location is marked as completed. '
                    'You will receive an invoice and confirmation email.',
                  ...
                  child: _processing
                      ? const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 10),
                            Text('Submitting...', style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w700)),
                          ],
                        )
                      : Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              'Submit Payment — \$${widget.item.price.toStringAsFixed(2)}',
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'Your payment for "${item.title}" will be processed once the meeting location is marked as completed.',
              textAlign: TextAlign.center,
              style: const TextStyle(fontSize: 14, color: cMuted, height: 1.65),
            ),
            const SizedBox(height: 24),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _Step(number: '1', text: 'Arrange a meeting location with the seller via Messages.'),
                  const SizedBox(height: 10),
                  _Step(number: '2', text: 'Meet up and exchange the item.'),
                  const SizedBox(height: 10),
                  _Step(number: '3', text: 'Mark the meeting as completed — your payment will then be processed.'),
                  const SizedBox(height: 10),
                  _Step(number: '4', text: 'An invoice and payment confirmation will be sent to $buyerEmail.'),
                ],
              ),
            ),
            const SizedBox(height: 16),
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Text(
                    'An invoice for ${item.title} (\$${item.price.toStringAsFixed(2)}) has been sent to $buyerEmail.',
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Text(title,
                style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: cText)),
          ]),
          const SizedBox(height: 12),
