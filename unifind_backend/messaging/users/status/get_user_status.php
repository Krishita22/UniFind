...
if ($lastActive !== null) {
    ...
    $online = $diff < 30; // online if active in last 5 minutes
api_success(['user_id' => $userId, 'online' => $online, 'last_active' => $lastActive, 'server_time' => date('Y-m-d H:i:s'), 'diff_seconds' => $diff]);
}
