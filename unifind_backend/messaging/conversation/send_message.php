...
// Paths: this file lives at UniFind_API/messaging/conversation/, so config.php
// and crypto.php sit two levels up at UniFind_API/.
...
try {
    $cipher = encrypt_message_body($text);
} catch (Throwable $e) {
    error_log('send_message encrypt: ' . $e->getMessage());
...
$stmt->bind_param('iis', $convId, $sender, $cipher);
