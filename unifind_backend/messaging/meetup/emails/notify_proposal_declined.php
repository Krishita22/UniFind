...
$subject = "❌ Your meetup proposal was declined";
...
<title>Meetup Proposal Declined</title>
</head>
          ...
          <tr>
            <td align="center" style="padding:40px 30px;">
              ...
              <p style="margin:0 0 20px 0; text-align:center; font-size:16px; line-height:1.6; color:#000000;">
                Unfortunately, <strong>' . htmlspecialchars($sellerName) . '</strong> has declined your meetup proposal.
              </p>
              ...
              <p style="margin:0 0 20px 0; text-align:center; font-size:16px; line-height:1.6; color:#000000;">
                You can log back into UniFind to propose a new time if you\'d like.
              </p>
