...
$buyerName  = $row['buyer_first']  ?? 'A student';
$sellerName = $row['seller_first'] ?? 'there';
$to         = $row['seller_email'];
...
if (empty($to)) {
    echo json_encode(['success' => false, 'error' => 'No seller email found']);
    exit();
}

$subject = "📍 " . $buyerName . " has withdrawn their meetup proposal";
...
<title>Meetup Proposal Withdrawn</title>
</head>
          ...
          <tr>
            <td align="center" style="padding:40px 30px;">
              ...
              <p style="margin:0 0 20px 0; text-align:center; font-size:16px; line-height:1.6; color:#000000;">
                <strong>' . htmlspecialchars($buyerName) . '</strong> has withdrawn their meetup proposal. No action is needed on your end.
              </p>
              ...
              <p style="margin:0 0 20px 0; text-align:center; font-size:16px; line-height:1.6; color:#000000;">
                If you are still interested in meeting up, you can log in to UniFind and continue the conversation.
              </p>
